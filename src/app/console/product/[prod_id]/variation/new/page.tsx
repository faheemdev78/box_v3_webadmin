...
function ProdVariationForm({ initialValues }: { initialValues: any }) {
    ...
    const [addProductVarient, add_details] = useMutation<any>(RECORD_ADD); // { data, loading, error }
    const [editProductVarient, edit_details] = useMutation<any>(RECORD_EDIT); // { data, loading, error }
