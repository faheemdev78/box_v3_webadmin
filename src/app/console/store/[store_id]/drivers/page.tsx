...
function DriverSettlements() {
  ...
  const [getDrivers] = useLazyQuery(GET_DRIVERS_WITH_PENDING_SETTLEMENT, {
    fetchPolicy: 'network-only'
  });
  const [settleWallet] = useMutation(SETTLE_DRIVER_WALLET);
  const [releaseOrders] = useMutation(RELEASE_DRIVER_ORDERS);
