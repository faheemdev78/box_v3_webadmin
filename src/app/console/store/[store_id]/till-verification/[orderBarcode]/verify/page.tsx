...
import { 
  WarningOutlined, ExclamationCircleOutlined, PrinterOutlined } from '@ant-design/icons';
...
import { ErrorComp, ProductHolder, PageFooter, AddBags, AddBaskets, WrongItem, ExcessiveItem } from './components';
...
const ReadyToDispatchWizard = ({
  ...
  const [printOk, set_printOk] = useState(false);
