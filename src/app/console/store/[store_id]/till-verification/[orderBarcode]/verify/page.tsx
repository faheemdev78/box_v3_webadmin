      ...
      <div className='bg-white'>
        ...
        {/* <div className="w-full p-3 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
          <div className="rounded-2xl p-6 flex items-center gap-4 bg-green-50">
            ...
            <div className="border-l border-dashed border-green-300 pl-4 flex-1">
              <div className="text-sm font-semibold text-gray-700 mb-1">Current Bill</div>
              <div className="text-3xl font-bold text-green-700">
                5,000 <span className="text-gray-400 text-lg font-normal">/ 10,000</span>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-2xl p-6 flex items-center gap-4 bg-blue-50">
            ...
            <div className="border-l border-dashed border-blue-300 pl-4 flex-1">
              <div className="text-sm font-semibold text-gray-700 mb-1">Bags</div>
              <div className="text-3xl font-bold text-blue-500">
                3 <span className="text-gray-400 text-lg font-normal">/ 45</span>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-2xl p-6 flex items-center gap-4 bg-violet-50">
            ...
            <div className="border-l border-dashed border-violet-300 pl-4 flex-1">
              <div className="text-sm font-semibold text-gray-700 mb-1">Customer Payable</div>
              <div className="text-3xl font-bold text-violet-500">10,045</div>
            </div>
          </div>
          ...
          <div className="rounded-2xl p-6 flex items-center gap-4 bg-amber-50">
            ...
            <div className="border-l border-dashed border-amber-300 pl-4 flex-1">
              <div className="text-sm font-semibold text-gray-700 mb-1">Total Items</div>
              <div className="text-3xl font-bold text-amber-500">
                2 <span className="text-gray-400 text-lg font-normal">/ 7</span>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-2xl p-6 flex items-center gap-4 bg-red-50">
            ...
            <div className="border-l border-dashed border-red-300 pl-4 flex-1">
              <div className="text-sm font-semibold text-gray-700 mb-1">Out of Stock Items/Amount</div>
              <div className="text-3xl font-bold text-red-500">
                2 <span className="text-gray-400 text-lg font-normal">/ 150</span>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-2xl p-6 flex items-center gap-4 bg-teal-50">
            ...
            <div className="border-l border-dashed border-teal-300 pl-4 flex-1">
              <div className="text-sm font-semibold text-gray-700 mb-1">FBR Fee</div>
