...
// export const TillVerificationPOS = () => {
...
// export const __TillVerificationPOS = () => {
//   const { store, store_id }:any = usePageProps()
//   const params = useParams()
//   const orderId = params.orderId as string
...
//           // Refetch locked orders to get the newly locked order
//           await refetch();
//         } catch (error: any) {
//           console.error('Failed to start order:', error);

//           // Check if the error is because order is already locked by this user
//           // Refetch locked orders to see if we already have it
//           const refetchResult = await refetch();

//           // Check if order is in the refetched orders
//           const refetchedOrders = refetchResult?.data?.getMyLockedOrders || [];
//           const isOrderInLockedOrders = refetchedOrders.some((o: any) => o._id === orderId);

//           console.log('Refetched orders:', refetchedOrders.length, 'Looking for:', orderId, 'Found:', isOrderInLockedOrders);

//           if (isOrderInLockedOrders) {
//             // Order was already locked by us, just set as current
//             console.log('Order was already locked by this user, resuming');
//             dispatch(setCurrentOrder(orderId));
//             message.info('Resuming order verification');
//           } else {
//             // Genuine error - order not available
...
//     initializeOrder();
//   }, [orderId, loadingOrders, orderData, initAttempted, dispatch, startOrder, router, store_id, refetch, lockedOrders]);
...
//               <Alert
//                 title="Warning!" description="Not all items have been verified. Continue anyway?"
//                 type="warning"
//                 showIcon
//                 style={{ marginTop: 8 }}
//               />
