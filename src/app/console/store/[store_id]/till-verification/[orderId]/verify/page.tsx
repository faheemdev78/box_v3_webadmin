...
export const TillVerificationPOS = () => {
  ...
  const [orderData, set_orderData] = useState<any>(null);

  // Find current order from locked orders
  // const orderData = false; // lockedOrders.find((o: any) => o._id === orderId);
  // console.log("activeShift: ", activeShift)
  // console.log("orderId: ", orderId)
  // console.log("lockedOrders: ", lockedOrders)
  ...
  useEffect(() => {
    ...
    const initializeOrder = async () => {
      ...
      if (!orderData) {
        ...
        try {
          ...
          // Refetch locked orders to get the order data
          // await refetch();
        } catch (error: any) {
    ...
    initializeOrder();
  }, [orderId, orderData, initAttempted, dispatch, startOrder, router, store_id]);
