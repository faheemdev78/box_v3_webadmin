...
import { capitalize } from './lodash_alt';
/*
...
export const SetBackground  = (_color, str) => ( _c[`bg${capitalize(_color)}`](str) );
// export const SetBackground = (_color, str) => (_c[`bg${String().toUpperCase(_color)}`](str) );
