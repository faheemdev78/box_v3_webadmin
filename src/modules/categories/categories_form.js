...
import { Drawer, Button, DevBlock } from '@/components';
import { string_to_slug } from '@/lib/utill';
import { publishStatus } from '@/configs';
import { ProdCatsDD } from '@/components/dropdowns';
...
import RECORD_ADD from '@/graphql/product_cat/addProductCat.graphql';
import DELETE_IMG from '@/graphql/product_cat/deleteProductCatImg.graphql';
