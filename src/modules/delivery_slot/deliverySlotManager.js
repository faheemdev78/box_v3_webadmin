...
import { Button, DeleteButton, DevBlock, IconButton, Loader, StatusTag, Table, AsyncSwitch } from '@/components';
import { DeliverySlotForm, DeliverySlotFormZone, SlotCopyForm, SlotFilter } from '@/modules/delivery_slot';
import { catchApolloError, checkApolloRequestErrors, timeStr2Date } from '@/lib/utill';
...
import LIST_DATA from '@/graphql/delivery_slots/deliverySlots.graphql'
import RECORD_DELETE from '@/graphql/delivery_slots/deleteDeliverySlot.graphql';
import ADD_ZONE from '@/graphql/delivery_slots/addZoneToSlot.graphql';
import EDIT_ZONE from '@/graphql/delivery_slots/editDeliverySlot.graphql';
import REMOVE_ZONE from '@/graphql/delivery_slots/removeZoneFromSlot.graphql';
