...
import { Drawer, Button, DevBlock, FileUploader, GMap, Loader } from '@/components';
...
import { LocationsDD, ManufacturersDD } from '@/components/dropdowns';
...
import GET_LOCATION from '@/graphql/location/location.graphql';
