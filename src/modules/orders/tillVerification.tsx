...
import ORDER_DETAILS_QUERY from '@_/graphql/order/orderDetails.graphql';
import VERIFY_ORDER_AT_TILL from '@_/graphql/order/verifyOrderAtTill.graphql';
import REJECT_ORDER_AT_TILL from '@_/graphql/order/rejectOrderAtTill.graphql';
...
export default function TillVerification({ serial }) {
    ...
    const [getOrderDetails, { loading }] = useLazyQuery(ORDER_DETAILS_QUERY);
