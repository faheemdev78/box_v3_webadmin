...
// import { Card, Table, Button, Tag, Space, Typography, Empty, message, Modal, Input } from 'antd';
// import { PlayCircleOutlined, UserOutlined, ShoppingOutlined, ClockCircleOutlined, PauseCircleOutlined,
//   LogoutOutlined, LoginOutlined, LockOutlined, PrinterOutlined
...
//     ) : (
//       <Card
//         style={{ marginBottom: 16, backgroundColor: '#f0f0f0', borderColor: '#d9d9d9' }}
//         size="small"
//       >
//         <Space style={{ width: '100%', justifyContent: 'space-between' }}>
