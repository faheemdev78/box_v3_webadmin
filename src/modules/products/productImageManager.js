...
import { DevBlock, FileUploader, IconButton, Thumbnail } from '@/components';
...
// import GET_PRODUCT from '@/graphql/product/get_product_images.graphql';

import UPDATE_MAIN_IMG from '@/graphql/product/uploadProductImg.graphql';
import DEL_MAIN_IMG from '@/graphql/product/deleteProductImg.graphql';
