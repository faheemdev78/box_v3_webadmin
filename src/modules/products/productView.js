...
import { Button, DevBlock, Drawer, Icon, IconButton, Loader, StatusTag, Image, Thumbnail, usePageProps } from '@/components';
...
import { Label as FormLabel } from '@/components/form';
import { ProductWrapper, ProdItendityForm, ProdVitalInfoForm, ProdLimitsForm, ProductsList, ProdDetailsForm, ProdVariationForm, 
    ...
    ProductImageManager} from "@/modules/products";
import { useRouter } from 'next/navigation';
import security from '@/lib/security';
// import Image from 'next/image';

import GET_VARIENTS from '@/graphql/product/products.graphql';
import UPDATE_PROD_STATUS from '@/graphql/product/editStoreProductStatus.graphql';
