...
import { Button, DevBlock, UserTypeDD } from '@/components';
...
import ADD_USER from '@/graphql/users/addUser.graphql'
import EDID_USER from '@/graphql/users/editUser.graphql'
